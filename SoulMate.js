hostname = api-account.soulapp.cn, chat-live.soulapp.cn, api-a.soulapp.cn, api-pay.soulapp.cn, gateway-mobile-gray.soulapp.cn, api-chat.soulapp.cn, 120.55.55.115, 120.55.62.124, 121.196.203.183, 47.96.20.45, 47.98.54.106, 118.31.112.221, 8.210.3.170, 47.75.72.47, post.soulapp.cn, api-user.soulapp.cn,api-account.soulapp.cn,ssp.soulapp.cn,47.110.187.87*.soulapp.cn,121.196.203.183,118.31.7.235,47.99.42.29,47.97.215.55,116.62.47.28,120.27.235.201,120.55.65.167,120.55.55.115,47.96.20.45,47.98.54.106,47.96.11.46,47.98.137.249,120.55.62.124,116.62.247.96,112.124.17.9,114.215.255.94,47.96.177.75,118.31.112.221,47.96.7.91,ssp.soulapp.cn, increase-openapi.soulapp.cn, data-collector.soulapp.cn, post.soulapp.cn, api-account.soulapp.cn, api-a.soulapp.cn, gateway-mobile-gray.soulapp.cn, api-user.soulapp.cn, chat-live.soulapp.cn, api-chat.soulapp.cn, 47.110.187.87,api-ucc.soulapp.cn,increase-openapi.soulapp.cn

 # 广告下发 
^https:\/\/ssp\.soulapp\.cn\/api\/q reject
^https:\/\/47\.110\.187\.87\/winterfell\/(?:v2\/)?getIpByDomain reject
# 主页瞬间指导
^https:\/\/post\.soulapp\.cn\/v\d\/post\/homepage\/guide\/card reject
# 去除青少年弹窗
^https:\/\/api-account\.soulapp\.cn\/teenager\/config reject
# 谁看过我横幅广告
^https:\/\/api-a\.soulapp\.cn\/official\/scene\/module reject
# 主页右下角悬浮广告
^https:\/\/api-user\.soulapp\.cn\/furion\/position\/content reject
# 拒绝收集用户数据
^https:\/\/data-collector\.soulapp\.cn\/api\/data\/report\/v2 reject
# 去除聊天界面再遇见
...
# 派对体验反馈
^https:\/\/chat-live\.soulapp\.cn\/live\/config\/rec-feedback reject
# 广场关注tab用户派对推荐
^https:\/\/post\.soulapp\.cn\/post\/relationUser\/chatRooms reject
# 聊天页通讯录tab邀请好友回归横幅
^https:\/\/increase-openapi\.soulapp\.cn\/increase\/dusting\/getAddressBookDustings reject
# 派对的关注tab隐藏猜我喜欢的派对
^https:\/\/chat-live\.soulapp\.cn\/live\/queryRelevantList reject
# 去广告
^https:\/\/api-chat\.soulapp\.cn\/chat\/limit\/socialGraceScore reject
^https:\/\/ad-h5-station-cdn\.soulapp\.cn\/station\/dist\.zip reject
^https:\/\/api-ucc\.soulapp\.cn\/app\/apollo\/config? reject 
# 去除聊天界面再遇见
^https:\/\/api-chat\.soulapp\.cn\/chat\/entrance\/first reject
# 去除通讯录右下角机器人图标
^https:\/\/api-chat\.soulapp\.cn\/addressBook\/showBubblingEnter reject
...
# 去除首次私聊打开星球交汇小卡片
^https:\/\/api-chat\.soulapp\.cn\/similar\/post\/intersect\/trigger reject
^https:\/\/api-user\.soulapp\.cn\/v6\/planet\/config? reject
# 去除首次打开私聊界面底部瞬间表情推荐
^https:\/\/api-chat\.soulapp\.cn\/chat\/guide\/defaultWord reject
# 去除聊天输入文字时的gif表情推荐
^https:\/\/api-chat\.soulapp\.cn\/chat\/emoji\/recommend reject
...
# 星球页面派对顶部派对分类tab
^https:\/\/chat-live\.soulapp\.cn\/live\/planet\/recListV2 url script-response-body https://raw.githubusercontent.com/ZenmoFeiShi/Qx/main/Soul.js
# 广场顶部tab
...
# 派对顶部榜单
^https:\/\/api-a\.soulapp\.cn\/chatroom\/calculateSoulList url script-response-body https://raw.githubusercontent.com/ZenmoFeiShi/Qx/main/Soul.js
# 派对页面tab
^https:\/\/chat-live\.soulapp\.cn\/chatroom\/getRoomTagInfo url script-response-body https://raw.githubusercontent.com/ZenmoFeiShi/Qx/main/Soul.js
# 派对列表中间横幅官方广告
...
^https:\/\/api-user\.soulapp\.cn\/user\/homepage\/metrics url script-response-body https://klraw.pages.dev/kelv1n1n/script/refs/heads/main/js/soul.js?token=209863
^https:\/\/post\.soulapp\.cn\/homepage\/tabs\/v2 url script-response-body https://klraw.pages.dev/kelv1n1n/script/refs/heads/main/js/soul.js?token=209863
#Soul  解锁阅读即焚功能
^https:\/\/api-chat\.soulapp\.cn\/snapchat\/url url script-response-body https://raw.githubusercontent.com/wangba2023/quantumult-X/main/soul.js
